  ...
  useEffect(() => {
    ...
    const translations: Record<'ru' | 'en', Record<string, string>> = {
      ru: {
        ...
        'hero.ctaPromo': 'Найти промокод',
        'hero.subHint': 'Коды, пробные периоды и акции на популярные сервисы',
      ...
      en: {
        ...
        'hero.ctaPromo': 'Find a promo code',
        'hero.subHint': 'Codes, free trials, and deals on popular services',
