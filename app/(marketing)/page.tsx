...
const IconGooglePlay = () => (
  <svg viewBox="0 0 512 512" style={{width:20,height:20,flexShrink:0}} xmlns="http://www.w3.org/2000/svg">
    <path d="M280.572,246.052L49.721,477.526c-11.034-10.465-16.997-24.819-16.997-40.374V74.096c0-15.849,6.263-30.207,17.597-40.968L280.572,246.052z" fill="#2299F8"/>
    <path d="M480.104,255.62c0,20.938-11.34,39.477-30.131,49.95l-65.605,36.482l-81.428-75.367l-22.367-20.634l86.193-86.429l83.207,46.056C468.764,216.152,480.104,234.69,480.104,255.62z" fill="#FFC107"/>
    <path d="M280.572,246.052L50.321,33.127c2.981-2.996,6.862-5.685,10.739-8.077c18.787-11.363,41.456-11.667,60.839-0.895l244.867,135.467L280.572,246.052z" fill="#5ACF5F"/>
    <path d="M384.367,342.053L121.899,487.095c-9.243,5.386-19.688,7.774-29.826,7.774c-10.734,0-21.469-2.69-31.013-8.668c-4.182-2.394-8.058-5.384-11.339-8.675l230.851-231.475l22.367,20.634L384.367,342.053z" fill="#F84437"/>
  </svg>
)
