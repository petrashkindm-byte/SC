  ...
  useEffect(() => {
    ...
    const translations: Record<'ru' | 'en', Record<string, string>> = {
      ru: {
        ...
        'how.step2.text': 'SubCuro предупредит о списании заранее, напомнит об окончании триала и покажет, где можно сэкономить.',
        ...
        'forwhom.l4b': 'Напоминание об окончании триала',
