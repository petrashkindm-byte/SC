    ...
    <>
      ...
      <div className="mb-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>, color: 'bg-[#fde8ea] text-[#e5484d]', val: String(overdueCount), lbl: p.statOverdueLabel },
        ].map((s, i) => (
